...
When she returned to her office, she started studying specs and headers. She developed a good understanding of the parts, but was having trouble putting together an end-to-end scenario. She realized he needed more information, so she requested a meeting with the developers, and brought a list of specific questions for them. This resulted in her learning some key facts that were not apparent in the specs.
She was able to combine use her existing knowledge with the extra info to write up a draft scenario with minimal content.
